...
public class ContactList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String whereClause = "userEmail = '" + ApplicationClass.user.getEmail() + "'"; //where user email == user currently logged in

        DataQueryBuilder queryBuilder = DataQueryBuilder.create();
        queryBuilder.setWhereClause(whereClause);
        queryBuilder.setGroupBy("name"); //this is how we sort data, by name

        showProgress(true);
        tvLoad.setText("Getting contacts.... please wait");
        ...
        Backendless.Persistence.of(Contact.class).find(queryBuilder, new AsyncCallback<List<Contact>>() {
            ...
            public void handleResponse(List<Contact> response)
            {
                ...
                adapater = new ContactsAdapter(ContactList.this, ApplicationClass.contacts);
                lvList.setAdapter(adapater);
                showProgress(false);
