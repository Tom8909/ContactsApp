...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText etMail, etPassword;
            ...
            public void onClick(View view) {
                if (etMail.getText().toString().isEmpty() || etPassword.getText().toString().isEmpty()) {
                    ...
                    Backendless.UserService.login(email, password, new AsyncCallback<BackendlessUser>() {
                        ...
                        {
                            ApplicationClass.user = response; //sets user to the logged in user
            ...
            public void onClick(View view)
            {
                ...
                else
                {
                    ...
                    Backendless.UserService.restorePassword(email, new AsyncCallback<Void>() {
                        ...
                        {
                            Toast.makeText(Login.this, "Reset instructions sent to specified email address", Toast.LENGTH_SHORT).show();
                            showProgress(false);
                        }
    ...
    tvLoad.setText("Checking login credentials.... please wait");
        ...
        Backendless.UserService.isValidLogin(new AsyncCallback<Boolean>() { //checking to see if a user is still logged in
            @Override
            public void handleResponse(Boolean response)
            {
                if (response)
                {
                   ...
                   String userObjectId = UserIdStorageFactory.instance().getStorage().get(); ///gets object Id for user
                   Backendless.Data.of(BackendlessUser.class).findById(userObjectId, new AsyncCallback<BackendlessUser>() {
                       ...
                       public void handleResponse(BackendlessUser response)
                       {
                           ApplicationClass.user = response;
                            startActivity( new Intent(Login.this, MainActivity.class));
                            Login.this.finish(); //finishes off this activity
                       }
